...
<nav class="flex flex-col gap-2 text-white">
  ...
  <a href="all_travel_reservations.php?adminID=<?php echo $adminID; ?>" class="flex items-center gap-3 p-3 rounded-lg hover:bg-[#67C090]/80 item transition">
    ...
    <div>
      <a href="admin_login.php" class="flex items-center gap-3 p-3 rounded-lg hover:bg-white/5 item transition"><i data-feather="log-out" class="w-5 h-5"></i> Logout</a>
    </div>
  </aside>
  ...
  <main class="flex-1 p-6 lg:p-12">
    ...
    <div class="flex flex-wrap gap-4 reveal">
      <a href="pending_customers.php?adminID=<?php echo $adminID; ?>" class="px-6 py-3 rounded-full bg-gradient-to-r from-[#67C090] to-[#26667F] text-white font-bold hover:scale-105 transition">Pending Customers</a>
      <a href="pending_reservations.php?adminID=<?php echo $adminID; ?>" class="px-6 py-3 rounded-full bg-gradient-to-r from-[#67C090] to-[#26667F] text-white font-bold hover:scale-105 transition">Pending Reservations</a>
      <a href="verified_customers.php?adminID=<?php echo $adminID; ?>" class="px-6 py-3 rounded-full bg-gradient-to-r from-[#67C090] to-[#26667F] text-white font-bold hover:scale-105 transition">Verified Customers</a>
      <a href="all_reservations.php?adminID=<?php echo $adminID; ?>" class="px-6 py-3 rounded-full bg-gradient-to-r from-[#67C090] to-[#26667F] text-white font-bold hover:scale-105 transition">All Reservations</a>
      <a href="all_travel_reservations.php?adminID=<?php echo $adminID; ?>" class="px-6 py-3 rounded-full bg-gradient-to-r from-[#67C090] to-[#26667F] text-white font-bold hover:scale-105 transition">Travel Company Reservations</a>
      <a href="no_show_today.php" class="px-6 py-3 rounded-full bg-gradient-to-r from-[#67C090] to-[#26667F] text-white font-bold hover:scale-105 transition">Today No Show Customers</a>
