...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        $stmt = $conn->prepare("INSERT INTO Manager (NIC, Username, Password, FirstName, LastName, PhoneNo, Email, Address) 
                                VALUES (:nic, :username, :password, :first_name, :last_name, :phone, :email, :address)");
...
<head>
    ...
    <title>Manager Register - Hotel System</title>
    <!-- Tailwind CSS CDN -->
...
<body class="bg-gradient-to-br from-[#124170] via-[#26667F] to-[#67C090] min-h-screen flex flex-col">
    ...
    <main class="flex-grow flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div class="w-full max-w-lg bg-white/20 backdrop-blur-lg rounded-2xl shadow-2xl p-8 text-white animate-slideIn">
            ...
            <h2 class="text-2xl font-semibold mb-6 text-center">Create Manager Account</h2>
            ...
            <p class="text-center mt-4">
                ...
                <a href="manager_login.php" class="text-[#DDF4E7] hover:text-white transition underline">Log In</a>
            </p>
        </div>
    </main>
    ...
    <!-- External JS -->
    <script src="../js/manager_register.js"></script>
</body>
</html>
