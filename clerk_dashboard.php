...
$clerkID = isset($_GET['clerkID']) ? intval($_GET['clerkID']) : 0;
...
<title>Clerk Dashboard - Hotel Reservation System</title>
    ...
    <div>
      <div class="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <div class="text-xs text-white/60">Clerk Panel</div>
        </div>
      </div>
<nav class="flex flex-col gap-2 text-white">
  ...
  <a href="all_travel_reservations.php?adminID=<?php echo $adminID; ?>" class="flex items-center gap-3 p-3 rounded-lg hover:bg-[#67C090]/80 item transition">
    ...
    <div>
      <a href="clerk_login.php" class="flex items-center gap-3 p-3 rounded-lg hover:bg-white/5 item transition"><i data-feather="log-out" class="w-5 h-5"></i> Logout</a>
    </div>
  </aside>
  ...
  <main class="flex-1 p-6 lg:p-12">
    ...
    <div class="flex justify-between items-center mb-8">
      <h1 class="text-3xl font-extrabold tracking-tight">Clerk Dashboard</h1>
    ...
    <div class="flex flex-wrap gap-4 reveal">
      <a href="cutomer_signup.php?clerkID=<?php echo $clerkID; ?>" class="px-6 py-3 rounded-full bg-gradient-to-r from-[#67C090] to-[#26667F] text-white font-bold hover:scale-105 transition">Register a Customers</a>
      <a href="customer_signin.php?clerkID=<?php echo $clerkID; ?>" class="px-6 py-3 rounded-full bg-gradient-to-r from-[#67C090] to-[#26667F] text-white font-bold hover:scale-105 transition">Reservations</a>
      <a href="all_travel_reservations.php?clerkID=<?php echo $clerkID; ?>" class="px-6 py-3 rounded-full bg-gradient-to-r from-[#67C090] to-[#26667F] text-white font-bold hover:scale-105 transition">Travel Company Reservations</a>
